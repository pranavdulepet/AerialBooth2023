...
class ImagicStableDiffusionPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        noise = torch.randn_like(self.image_latents_hom) * self.scheduler.init_noise_sigma
        noisy_homography_latents = self.image_latents_hom + noise

        latents = noisy_homography_latents
