...
def run_diffusion_experiment(init_image_path, zero_output_path, output_dir, prompt, device='cuda'):
    ...
    pipe = DiffusionPipeline.from_pretrained(
        ...
        custom_pipeline='./models/aerialbooth_sum',
        cache_dir='dir_name',
    ...
    aerial_hom = sub_images[0].resize((512, 512))
    bottom_hom = sub_images[1].resize((512, 512))
    side_hom = sub_images[2].resize((512, 512))
    back_hom = sub_images[3].resize((512, 512))
